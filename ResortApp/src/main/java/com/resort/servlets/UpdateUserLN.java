...
/**
 * Servlet implementation class UpdateUserLN
 */
@WebServlet("/updateUserLN")
public class UpdateUserLN extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Inside of UpdateLN!");
		
		String ln = request.getParameter("lastname");
		serv.updateUserLN(ln, temp.getUserid());
